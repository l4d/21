...
Scheme
{
	...
	Colors
	{
		...
		"maincolor"			"25 25 25 255"
		
		// recommended colors for readability
		// watermelon - 168 26 26 255
		// tangerine - 219  72 12 255
		// clear sky - 26 160 244 255
	}
	...
	BaseSettings
	{
		...
		Button.ArmedBgColor				"highlight"				[$WIN32]
		Button.ArmedBgColor				"blank"		[$X360]
		Button.DepressedTextColor		"text-highlight"
		Button.DepressedBgColor			"highlight"
		...
		Frame.BgColor					"20 20 20 250"	[$WIN32]	//frame color
		Frame.BgColor					"80 80 80 192"		[$X360]
		Frame.OutOfFocusBgColor			"20 20 20 115"	[$WIN32]
		Frame.OutOfFocusBgColor			"80 80 80 192"		[$X360]
		Frame.FocusTransitionEffectTime	"4.0"							// time it takes for a window to fade in/out on focus/out of focus
		...
		// info towards bottom left 4 dead label
		...
		Label.DisabledFgColor2			"blank" //hidden text while no option to click

		ListPanel.TextColor					"DullWhite"  // server list text color
		ListPanel.TextBgColor				"255 0 255 255"
		ListPanel.BgColor					"transparentblack"   //server browser ugly bg (1st tab)
		ListPanel.SelectedTextColor			"text-highlight"
		ListPanel.SelectedBgColor			"Orange"
		ListPanel.SelectedOutOfFocusBgColor	"255 155 0 128"
		ListPanel.EmptyListInfoTextColor	"OffWhite" // empty server text msg

		Menu.TextColor					"White"
		Menu.BgColor					"20 20 20 245"	//console dropdown
		Menu.ArmedTextColor				"white"
		Menu.ArmedBgColor				"transparentblack"
		Menu.TextInset					"3"

		Panel.FgColor					"DullWhite"
		Panel.BgColor					"Blank"		//panel inside frame
		...
		RichText.BgColor				"transparentblack" //ugly console body bg 10 10 10 245
		RichText.SelectedTextColor		"black"
		RichText.SelectedBgColor		"white"	//highlight  console

		ScrollBar.Wide					8

		ScrollBarButton.FgColor				"blank"			//up down buttons scroll
		...
		TextEntry.TextColor			"white" //console text entry text color
		TextEntry.BgColor			"blank" //console text entry and sv browser 1st tab input boxes
		TextEntry.CursorColor		"white"
		TextEntry.DisabledTextColor	"DullWhite"
		TextEntry.DisabledBgColor	"Blank"
		TextEntry.SelectedTextColor	"text-highlight"
		TextEntry.SelectedBgColor	"highlight"
		TextEntry.OutOfFocusSelectedBgColor	"highlight"
		...
		MainMenu.ArmedTextColor		"highlight"	[$WIN32]
		...
		Console.TextColor			"28 102 201 255"
	...
	Fonts
	{
		...
		"DefaultFixedOutline"	//net_graph font
		{
			"1"
			{
				"name"		 "Verdana"
		...
		"Default"   //server broser button text 1st tab
		{
			"1"
			{
				"name"		"Tahoma"
		...
		"DefaultSmall"			//server browser txt size 1st tab
		{
			"1"
			{
				"name"		"Tahoma"
